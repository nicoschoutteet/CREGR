...
theme_CREG <- function() {
  theme_classic() %+replace%
    theme(plot.title = element_markdown(size = 10, hjust = 0, colour = colour_CREG_function("blue1")),
          plot.subtitle = element_markdown(size = 8, hjust = 0, margin = margin(0, 0, .5, 0, "cm")),
